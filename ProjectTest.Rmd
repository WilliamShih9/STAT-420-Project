...
knitr::kable(frame2, digits = 2, caption = "Evaluation of Models (Test RMSE of XBoost Tree = 183.80)")
```
```{r, message = FALSE}
...
knitr::kable(power_RMSE, caption = "Adjusted R^2 and Test RMSE using power transformations of response variable of BIC model (Predictions Clamped at 0)")
```
...
knitr::kable(frame3, caption = "Evaluation of Models Again")
```
