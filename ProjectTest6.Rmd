...
aic_formula = formula(RentedBikeCount ~ Month + Hour + Temperature + Humidity + Wind + 
  Visibility + DewPoint + SolarRadiation + Rainfall + Snowfall + 
  Season + Holiday + Functional + Weekend + factor(Hour) + 
  I(Temperature^2) + I(Wind^2) + Month:Temperature + Month:DewPoint + 
  Month:SolarRadiation + Month:Rainfall + Month:Season + Month:Functional + 
  ...
  Temperature:Visibility + Temperature:DewPoint + Temperature:Rainfall + 
  Temperature:Season + Temperature:Holiday + Temperature:Weekend + 
  Humidity:Wind + Humidity:Visibility + Humidity:DewPoint + 
  Humidity:SolarRadiation + Humidity:Rainfall + Humidity:Season + 
  Humidity:Functional + Humidity:Weekend + Wind:Visibility + 
  Wind:DewPoint + Wind:SolarRadiation + Wind:Season + Wind:Holiday + 
  Wind:Weekend + Visibility:DewPoint + Visibility:SolarRadiation + 
  DewPoint:SolarRadiation + DewPoint:Rainfall + DewPoint:Season + 
  DewPoint:Holiday + DewPoint:Functional + DewPoint:Weekend + 
  SolarRadiation:Rainfall + SolarRadiation:Season + SolarRadiation:Holiday + 
  SolarRadiation:Functional + SolarRadiation:Weekend + Rainfall:Snowfall + 
  Rainfall:Season + Rainfall:Holiday + Rainfall:Weekend + Season:Holiday + 
  Season:Functional + Holiday:Functional + Functional:Weekend + 
  Weekend:factor(Hour) + Month:I(Temperature^2) + DewPoint:I(Temperature^2) + 
  Rainfall:I(Temperature^2) + Season:I(Temperature^2) + Holiday:I(Temperature^2) + 
  Hour:I(Wind^2) + Wind:I(Wind^2) + Visibility:I(Wind^2) + 
  Rainfall:I(Wind^2) + Snowfall:I(Wind^2) + Season:I(Wind^2) + 
  Holiday:I(Wind^2) + Weekend:I(Wind^2))
bic_formula = formula(RentedBikeCount ~ Month + Hour + Temperature + Humidity + Wind + 
                        Visibility + DewPoint + SolarRadiation + Rainfall + Snowfall + 
                        Season + Holiday + Functional + Weekend + factor(Hour) + 
                        I(Temperature^2) + I(Wind^2) + Month:Hour + Month:Temperature + 
                        Month:SolarRadiation + Month:Season + Month:Functional + 
                        Hour:Temperature + Hour:Humidity + Hour:Wind + Hour:DewPoint + 
                        Hour:SolarRadiation + Hour:Rainfall + Hour:Holiday + Hour:Functional + 
                        Temperature:Wind + Temperature:Visibility + Temperature:DewPoint + 
                        Temperature:Rainfall + Temperature:Season + Temperature:Weekend + 
                        Humidity:Wind + Humidity:Visibility + Humidity:DewPoint + 
                        Humidity:SolarRadiation + Humidity:Season + Humidity:Functional + 
                        Humidity:Weekend + Wind:Visibility + Wind:DewPoint + Wind:SolarRadiation + 
                        ...
                        DewPoint:Weekend + SolarRadiation:Season + SolarRadiation:Functional + 
                        SolarRadiation:Weekend + Rainfall:Snowfall + Season:Holiday + 
                        Season:Functional + Holiday:Functional + Weekend:factor(Hour) + 
                        Month:I(Temperature^2) + DewPoint:I(Temperature^2) + Rainfall:I(Temperature^2) + 
                        Season:I(Temperature^2) + Holiday:I(Temperature^2) + Hour:I(Wind^2) + 
                        Visibility:I(Wind^2) + Season:I(Wind^2))
...
best_formula = formula(sqrt(RentedBikeCount) ~ . + factor(Hour)*Weekend + 
